...
namespace reservationSalles2018
{
    public partial class M2LReservationSalles : Form
    {
        ...
        {
            if (this.ActiveMdiChild != null && this.ActiveMdiChild.Text != "factures")
            {
                this.ActiveMdiChild.Close();
            }
            ...
            if (this.ActiveMdiChild == null)
            {
                factures Ffactures = new factures();
                Ffactures.MdiParent = this;
                Ffactures.WindowState = FormWindowState.Maximized;
                Ffactures.Show();
        ...
        {
            if (this.ActiveMdiChild != null && this.ActiveMdiChild.Text != "statistiques")
            {
                this.ActiveMdiChild.Close();
            }
            ...
            if (this.ActiveMdiChild == null)
            {
                mission3 Ffactures = new mission3();
                Ffactures.MdiParent = this;
                Ffactures.WindowState = FormWindowState.Maximized;
                Ffactures.Show();
