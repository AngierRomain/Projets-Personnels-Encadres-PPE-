...
namespace reservationSalles2018
{
    public partial class salles : Form
    {
        ...
        private void btnRechercheSalle_Click(object sender, EventArgs e)
        {
            ...
            if (index == -1)
            {
                //On retourne l'erreur "Salle Introuvable."
        ...
        private void btnEnregistrerSalle_Click(object sender, EventArgs e)
        {
            ...
            {
                //On essaye de convertir en int 16 la saisie utilisateur.
                try
                {
                ...
                {
                //Si ça ne marche pas on demande à l'utilisateur de recommencer.
                ...
                {
                    //On essaye de convertir la saisie utilisateur en int16.
                    try
                    {
                    ...
                    //On dit à l'utilisateur de rectifier sa saisie.
                    catch
                    {
        ...
        {
            //Initialisation de la variable idSalle
            int idSalle;
